...
function handleInput(event: Event) {
  ...
  // H5 在 event.target.value。两者都兼容，缺失时兜底空串。
...
<template>
  ...
  >
    ...
    <input
      ...
      @input="handleInput"
    />
    <text v-if="showClear" class="animal-input__clear" role="button" tabindex="-1" @click="handleClear">×</text>
