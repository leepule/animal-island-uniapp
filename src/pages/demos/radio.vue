...
const code = `<AiRadio v-model="value" :options="options" />
<AiRadio :options="options" direction="vertical" />
<AiRadio :options="options" disabled />`;
</script>
...
<template>
    ...
    <view class="demo-page">
        ...
        <view class="demo-box">已选中：<text style="color: #19c8b9; font-weight: 600">{{ seasonOptions.find(o => o.value === selected1)?.label ?? '无' }}</text></view>
        <view class="demo-box"><AiRadio v-model="selected1" :options="seasonOptions" /></view>

        <view class="demo-label">垂直排列 + 含禁用选项</view>
        <view class="demo-box"><AiRadio v-model="selected2" :options="fruitOptions" direction="vertical" /></view>

        <view class="demo-label">小尺寸 / 大尺寸</view>
        <view class="demo-box"><AiRadio v-model="selected4" :options="timeOptions" size="small" /></view>
        <view class="demo-box"><AiRadio v-model="selected3" :options="timeOptions" size="large" /></view>

        <view class="demo-label">全部禁用</view>
        <view class="demo-box"><AiRadio v-model="selected5" :options="seasonOptions" disabled /></view>
